...
//		System.out.println();
	...
	//			100, 100,100,100},g);
	Broadcast b4 = new Broadcast(4,new int[]{1,2,3},new int[]{100,100,100},g);
	//Broadcast b = new Broadcast(1, new int[] { 2, 3, 4,5,6,7,8,9}, new int[] { 100,
		//		100, 100,100,100,100,100,100,100},g);
		Broadcast b = new Broadcast(3, new int[] {1,2,4}, new int[] { 100,100,100},g);
	//	Broadcast b2 = new Broadcast(2, new int[] {3,4}, new int[] {90,100},g);
	//	Broadcast b1 = new Broadcast(1, new int[] {2,8}, new int[] {100,100},g);
	//	b.getMinBitrate(1);
